...
# LLM
LLM_MODEL_PATH: str = os.getenv("LLM_MODEL_PATH", "./gguf_models/mistral-7b-instruct-v0.2.Q3_K_M.gguf")
...
# RAG
TOP_K_MEMORIES: int = int(os.getenv("TOP_K_MEMORIES", "2"))
TOP_K_NOTES:    int = int(os.getenv("TOP_K_NOTES",    "1"))

# Distress thresholds
PITCH_AGITATION_THRESHOLD:  float = float(os.getenv("PITCH_AGITATION_THRESHOLD",  "500.0"))
SILENCE_CONFUSED_THRESHOLD: float = float(os.getenv("SILENCE_CONFUSED_THRESHOLD", "0.50"))
